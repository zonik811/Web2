...
async function createPagosClientesCollection() {
    try {
        console.log('💳 Creando colección de Pagos de Clientes...');
        ...
        await databases.createStringAttribute(DATABASE_ID, COLLECTION_ID, 'facturaId', 255, false);
        await new Promise(resolve => setTimeout(resolve, 1000));
        ...
        await databases.createStringAttribute(DATABASE_ID, COLLECTION_ID, 'referencia', 500, false);
        await new Promise(resolve => setTimeout(resolve, 1000));

        await databases.createStringAttribute(DATABASE_ID, COLLECTION_ID, 'observaciones', 1000, false);
        await new Promise(resolve => setTimeout(resolve, 1000));
        ...
        console.log('🎉 ¡Colección de Pagos Clientes configurada exitosamente!');
